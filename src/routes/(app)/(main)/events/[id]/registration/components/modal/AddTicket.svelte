...
{#if open}
	...
	>
		...
		>
				...
				{#if allowSalesStart}
					<div class="mt-2 flex items-center">
						<input
							...
							class="h-[38px] rounded-l-md border bg-white px-2 text-sm focus:outline-none"
						/>
						<input
							type="text"
							bind:value={salesStartTime}
							class="h-[38px] w-25 rounded-r-md border bg-white px-2 text-sm focus:outline-none"
						/>
					</div>
				{/if}
			...
			{:else}
				<div class="mt-3 flex items-center gap-1 text-xs font-medium text-[#B2B3B3]">
					<svg
						width="15"
						height="15"
						viewBox="0 0 15 15"
