<!-- src/lib/components/CompanyQuestionModal.svelte -->
<script lang="ts">
		...
		>
			...
			<div class="space-y-5">
				<div class="flex items-center space-x-3">
					...
					>
						<img src="/buildings-2.svg" alt="arrow back" />
					</div>
					<div>
						<h3 class="font-medium">Company</h3>
						<p class="text-sm text-gray-600">Ask for the company the guest works for</p>
					</div>
				</div>
				...
				<div class="space-y-3">
					...
					<div class="text-xs font-medium text-gray-600">{questionData.helpText}</div>
				</div>
