<script lang="ts">
	...
	let eventName = '';
	let startTime = '2025-09-14T19:30';
	let endTime = '2025-09-14T20:30';
	let eventType = '';
	let eventCategory = '';
	let location = '';
	let description = '';
			...
			<div class="space-y-4">
				...
				>
					<button class="flex items-center gap-2">
						...
						>
							<rect y="0.875" width="54" height="36.75" rx="3.75" fill="#E5DEE5" />
							<rect x="24.75" y="6.875" width="22.5" height="3" rx="1.5" fill="#F0EBEF" />
							<rect x="24.75" y="11.375" width="22.5" height="3" rx="1.5" fill="#F0EBEF" />
							<rect x="24.75" y="15.875" width="22.5" height="3" rx="1.5" fill="#F0EBEF" />
							<rect x="24.75" y="20.375" width="19.5" height="3" rx="1.5" fill="#F0EBEF" />
							<rect x="24.75" y="24.875" width="12.75" height="3" rx="1.5" fill="#F0EBEF" />
							<rect
								x="6.375"
								y="7.25"
								width="15"
						...
						<div>
							<div class="text-xs" style="color: {selectedTheme.lightText};">Theme</div>
					...
					<button aria-label="change theme">
						...
						>
							...
							<path
								...
								stroke-linejoin="round"
							/>
							<rect x="8.625" y="12.125" width="4.5" height="0.75" fill="#B99492" />
							<rect
								x="8.625"
								y="12.125"
								width="4.5"
				...
				>
					...
					<div>
						<div class="text-xs" style="color: {selectedTheme.lightText};">Create Event</div>
				...
				>
					...
					<div>
						<div class="text-xs" style="color: {selectedTheme.lightText};">Action</div>
		...
		<div class="w-full space-y-5 p-6 lg:max-w-2xl lg:p-0">
			...
			<div class="flex items-center justify-between text-sm">
				...
				>
					...
					>
						<path
							d="M9.75 16.625C13.8921 16.625 17.25 13.2671 17.25 9.125C17.25 4.98286 13.8921 1.625 9.75 1.625C5.60786 1.625 2.25 4.98286 2.25 9.125C2.25 13.2671 5.60786 16.625 9.75 16.625Z"
							stroke="#9D6E6C"
							stroke-width="1.125"
							stroke-linecap="round"
							stroke-linejoin="round"
						/>
						<path
							d="M6.74922 2.375H7.49922C6.03672 6.755 6.03672 11.495 7.49922 15.875H6.74922"
							stroke="#9D6E6C"
							stroke-width="1.125"
							stroke-linecap="round"
							stroke-linejoin="round"
						/>
						<path
							d="M12 2.375C13.4625 6.755 13.4625 11.495 12 15.875"
							stroke="#9D6E6C"
							stroke-width="1.125"
							stroke-linecap="round"
							stroke-linejoin="round"
						/>
						<path
							d="M3 12.125V11.375C7.38 12.8375 12.12 12.8375 16.5 11.375V12.125"
							stroke="#9D6E6C"
							stroke-width="1.125"
							stroke-linecap="round"
							stroke-linejoin="round"
						/>
						<path
							d="M3 6.87813C7.38 5.41563 12.12 5.41563 16.5 6.87813"
							stroke="#9D6E6C"
							stroke-width="1.125"
							stroke-linecap="round"
							stroke-linejoin="round"
			...
			<input
				...
				class="w-full py-1 text-4xl font-semibold focus:outline-none"
				style=""
			/>
			...
			<div class="flex w-full gap-4">
				<div class="flex w-full flex-col items-start justify-between gap-4 md:flex-row">
					...
					>
						...
						<div class="flex flex-col items-start">
							<div class="flex items-center space-x-2">
								<span
									...
									style="background-color: {selectedTheme.dateFill};"
								></span>
								<span class="font-medium">Start</span>
							</div>
							<div
								class="ml-1 h-8 border-2 border-dashed"
								style="border-color: {selectedTheme.dateFill};"
							></div>
							<div class="flex items-center space-x-2">
								<span
						...
						<div class="flex w-full max-w-[243px] flex-col items-center space-x-4">
							<div class="grid w-full grid-cols-2 items-center gap-2">
								<span
									class="rounded-t-r p-2 text-sm font-semibold"
									style="background-color: {selectedTheme.smallCover}; border-top-left-radius: 9.75px;"
									>Sat, Sep 14</span
								>
								<span
									class="w-full p-2 text-sm font-semibold"
									style="background-color: {selectedTheme.smallCover}; border-top-right-radius: 9.75px;"
									><p class="ml-auto w-fit">07:30 PM</p></span
								>
								<span
									class="p-2 text-sm font-semibold"
									style="background-color: {selectedTheme.smallCover}; border-bottom-left-radius: 9.75px;"
									>Sat, Sep 14</span
								>
								<span
									class="w-full p-2 text-sm font-semibold"
									style="background-color: {selectedTheme.smallCover}; border-bottom-right-radius: 9.75px;"
									><p class="ml-auto w-fit">08:30 PM</p></span
								>
							</div>
						</div>
					</div>
					...
					>
						...
						<span>GMT+01:00</span>
						<span style="color: {selectedTheme.lightText};">Lagos</span>
					</div>
				</div>
			</div>
			...
			<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
				...
				>
					<div class="flex items-center gap-1">
						...
						>
							<path
								d="M1.66699 4.78964C1.66699 2.74414 3.3252 1.08594 5.3707 1.08594H14.63C16.6755 1.08594 18.3337 2.74414 18.3337 4.78964C18.3337 5.24238 18.074 5.65501 17.6659 5.85092L17.2597 6.04587C15.8278 6.73319 15.8278 8.77202 17.2597 9.45934L17.6659 9.65428C18.074 9.8502 18.3337 10.2628 18.3337 10.7156C18.3337 12.7611 16.6755 14.4193 14.63 14.4193H5.3707C3.3252 14.4193 1.66699 12.7611 1.66699 10.7156C1.66699 10.2628 1.92663 9.8502 2.33479 9.65428L2.74093 9.45934C4.17284 8.77202 4.17284 6.73319 2.74093 6.04587L2.33479 5.85092C1.92663 5.65501 1.66699 5.24238 1.66699 4.78964Z"
								stroke="#B99492"
								stroke-width="1.5"
							/>
							<path
								d="M10.8483 5.86708C11.106 5.04778 12.228 5.04778 12.4857 5.86708C12.601 6.23348 12.9315 6.48155 13.3045 6.48155C14.1384 6.48155 14.4852 7.58391 13.8105 8.09026C13.5088 8.31671 13.3825 8.7181 13.4977 9.0845C13.7555 9.90379 12.8477 10.5851 12.173 10.0787C11.8713 9.85229 11.4627 9.85229 11.161 10.0787C10.4863 10.5851 9.57853 9.9038 9.83624 9.0845C9.95149 8.7181 9.82523 8.31671 9.52351 8.09026C8.84883 7.58391 9.19557 6.48155 10.0295 6.48155C10.4025 6.48155 10.733 6.23348 10.8483 5.86708Z"
								stroke="#B99492"
								stroke-width="1.5"
							/>
						</svg>
			...
			<!-- Location -->
			<div class="rounded-[9.75px] p-3" style="background-color: {selectedTheme.cover};">
				<div class="flex items-center gap-1">
					<svg
						width="18"
						height="19"
			...
			<!-- Description -->
			<div class="custom-scrollbar relative w-full">
				<div class="pointer-events-none absolute top-2 left-3 text-gray-400">
					<svg
						width="18"
						height="19"
						viewBox="0 0 18 19"
				...
				<textarea
					...
					class="h-10 w-full resize-none rounded-md py-2 pr-3 pl-9 focus:outline-none"
					style="background-color: {selectedTheme.cover};"
				></textarea>
			</div>
			...
			<div class="space-y-2">
				...
				<div style="background-color: {selectedTheme.cover};" class="space-y-4 p-3">
					<!-- Tickets -->
					<div class="flex items-center justify-between">
						...
						<div class="flex items-center gap-1">
							<span class="" style="color: {selectedTheme.lightText};">Free</span>
					...
					<div class="flex items-center justify-between">
						...
						<div class="flex items-center gap-1">
							<span class="" style="color: {selectedTheme.lightText};">Unlimited</span>
							<svg
								width="14"
								height="15"
								viewBox="0 0 14 15"
			...
			<!-- Submit -->
			<button
				class="h-[49.5px] w-full rounded-[9.75px] py-2 font-semibold text-white transition"
				style="background-color: {selectedTheme.button};"
			>
				Create Event
			</button>
		</div>
