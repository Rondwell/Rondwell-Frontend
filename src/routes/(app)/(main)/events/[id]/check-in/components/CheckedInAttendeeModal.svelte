		...
		>
			...
			<div class="custom-scrollbar flex-1 overflow-y-auto px-6 pt-4 pb-10 md:pb-4">
				...
				<div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
					...
					>
						<button
							class="flex items-center gap-1 rounded-md bg-[#E3F4E1] px-3 py-1 text-xs text-[#3CBD2C]"
				...
				<div class="mt-4 flex flex-wrap items-center gap-6 text-gray-400">
					...
					<div>
						...
						<p class="text-sm font-semibold text-black">{attendee.ticketType}</p>
					</div>
				</div>
			...
			>
				...
				<button
					class="mt-3 w-full rounded-md bg-[#FEF3F2] px-4 py-2 text-sm font-medium text-[#D92D20] hover:bg-[#FEE4E2]"
				>
					Undo Check In
				</button>
			</div>
