...
<div class="hidden sm:justify-between lg-block md:mb-10 md:flex">
	...
	<section class="flex flex-col gap-0">
        <div class="grid grid-cols-2 gap-4 sm:grid-cols-2 md:grid-cols-4">
		    {#each stats as stat}
                <div class="stat-card ">
                    <div class="text-[#A2A5A6] flex items-center justify-items-center gap-0.5">
...
<div class="mb-6">
		...
		<div class="mt-10 min-h-90 border-t pt-8 text-center">
		
			<div class="flex mt-10 h-50 flex-col items-center justify-center">
				<!-- Placeholder icon -->
	...
	<div class="mb-6">
		<div class="mb-8 space-y-4">
			...
			<div class="flex my-20  h-50 flex-col items-center justify-center">
				<!-- Placeholder icon -->
				<img src="/feedback-image.svg" alt="" />
				<div class="text-lg font-medium text-[#646568]">No Feedback, yet</div>
				<div class="mt-1 mb-10 text-xs text-gray-400">
					When people  pay for events under your calendar, they will appear here. 
				</div>
			</div>
