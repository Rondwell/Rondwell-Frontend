  ...
  <div class="flex items-center justify-between mb-6">
    ...
    <div>
      <div class="flex items-center gap-2">
        <h1 class="text-xl font-semibold text-gray-900">My Proactive Collaboration Requests</h1>
        <span class="text-xs font-medium bg-gray-200 text-gray-700 px-2 py-0.5 rounded-full">
          {enagagement.length}
        </span>
      </div>
      <p class="text-sm text-gray-500 mt-1">
        Track requests you've sent to organizers for potential speaking enagagement
      </p>
    </div>
