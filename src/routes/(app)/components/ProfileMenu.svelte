	...
	>
		...
		<div class="mt-4 space-y-2 rounded-md bg-[#FFFFFF] p-2 shadow-sm">
			{#each displayedProfiles as profile}
				...
				>
					<div class="relative">
						<img src={profile.img} alt="profile icon" class="h-8 w-8 rounded-full" />
					</div>
			...
			<div class="flex cursor-pointer items-center gap-2">
				...
				>
					...
					>
						...
						/>
						<path
							d="M5.25 6.86911C5.25 6.17161 5.82 5.60156 6.5175 5.60156C7.215 5.60156 7.75 6.17161 7.785 6.86911C7.785 8.27911 5.7825 8.42911 5.34 9.77161C5.25 10.0491 5.4825 10.3266 5.775 10.3266H7.785"
							stroke="#2A2D32"
							stroke-width="1.5"
							stroke-linecap="round"
							stroke-linejoin="round"
