...
<script>
	...
	<div class="mx-auto max-w-lg">
		...
		<div class="p-0 sm:p-4">
			<h2 class="mb-4 sm:mb-6 text-lg sm:text-xl font-bold text-[#192226]">
			Fill Contact form
			</h2>
			...
			<form on:submit={handleSubmit} class="space-y-5">
				...
				<div>
					...
					<input
						...
						class="w-full rounded-lg border-0 bg-[#EFEFEF] px-4 py-2.5 sm:py-3 text-[#192226] placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-200"
					/>
				</div>
				...
				class="mt-6 w-full rounded-lg bg-[#3D3D3D] px-6 py-3 sm:py-3.5 font-semibold text-white transition hover:bg-[#2D2D2D] disabled:cursor-not-allowed disabled:opacity-50"
				>
