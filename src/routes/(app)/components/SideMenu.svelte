	...
	{#if showScrollBtn}
		<div class="bg fade-in">
			<button
				...
				class="scroll-bg fixed right-0 top-[20px] z-50 flex h-12 w-12 cursor-pointer items-center justify-center rounded-full p-3 shadow-xl transition duration-300"
			>
...
<aside
	class="fixed left-[117px] top-0 z-10 hidden h-screen w-[250px] flex-col items-start justify-start gap-10 border-r px-6 py-10 md:flex"
>
	<a href="/overview">
