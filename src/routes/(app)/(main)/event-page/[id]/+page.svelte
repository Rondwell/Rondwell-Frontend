		...
		<div class="hidden md:block">
			<div class="flex gap-3 justify-between">
								<div class="flex gap-3 ">
									<div class="size-9 bg-green-300 rounded-[9px] "></div>
							<div>
					<p>Presented by</p>
					<h2 class="flex ">💰    Get Funded! Offi... <span>
					<svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_1_8843)">
<path d="M7 12L11 8L7 4" stroke="#480000" stroke-opacity="0.36" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
</g>
<defs>
...
<rect width="16" height="16" fill="white" transform="translate(1)"/>
				...
				<button class="text-[#480000] py-2.5 px-3.5 text-base leading-4 bg-[#511A00]/6 rounded-full font-normal ">
					Subscribe
				</button>
			</div>
			<p class=" mt-3.5 text-[#AA644B] text-[15px] font-light leading-6">
				Empowering transformational change in
entrepreneurs and driven professionals through
compassionate coaching. Are you ready to steDanielp
			</p>
			<div class="mt-14.5 flex flex-col ">
				<h3 class="text-[#7F2400]/80 text-base font-normal pb-[9px] border-b border-[#7F2400]/8 mb-[19px]">Organized By</h3>
			...
			<div class="mt-6.5 flex flex-col ">
				<h3 class="text-[#7F2400]/80 text-base font-normal pb-[9px] border-b border-[#7F2400]/8 mb-[19px]">119 Attending</h3>
				<div class="space-y-[10px]">
					...
					<!-- Attending  -->
					 <div class="relative flex items-center gap-1 text-sm text-gray-600">
						...
						<span
							class="absolute top-0 left-10 rounded-[11.2503px] bg-[#F4F4F4] px-2 py-1 border border-[#FFF0E6] text-xs text-[#7F7F81]"
							>+59</span
						>
					</div>
					<p class="max-w-[334px] text-[15px] text-[#7F2400]/80">Tucker Cohen, Gabriel Funsho, Bbloloa, and 116 
others</p>
				</div>
			</div>
			<div class="space-y-[10px] flex flex-col mt-7">
				<a href="#" class="text-[#480000]/36 text-[15px] font-normal leading-3.5 ">
