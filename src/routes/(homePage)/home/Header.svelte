...
<div class="relative z-50 h-[70px] w-full p-2 lg:border-b lg:border-[#909EA3] lg:p-0">
	<header
	...
	>
		<div class="flex w-full items-center justify-between">
			...
			<nav class="hidden items-center gap-8 text-[#909EA3] lg:flex">
				...
				<a href="/pricing" class="flex items-center gap-1 transition">
			...
			<div class="flex items-center gap-4 text-[#909EA3] lg:gap-10">
				<div class="flex items-center gap-4">
					...
					<a
						href="/create-event"
						class="hidden items-center gap-1 border-l border-gray-400 pl-4 transition lg:flex"
					>
		...
		<!-- Mobile menu -->
		{#if isOpen}
			<div class="z-50 w-full py-4 text-center text-lg text-white lg:hidden">
