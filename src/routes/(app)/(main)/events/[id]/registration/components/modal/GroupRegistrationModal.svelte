		...
		<div class="relative w-[315px] max-w-lg rounded-lg bg-[#FFFCFC] p-4 shadow-lg">
			<div class="mb-3 flex h-[60px] w-[60px] items-center justify-center rounded-full bg-[#EFF0F0]">
				<div class="flex h-9 w-9 items-center justify-center">
					<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path opacity="0.4" d="M34.2712 21.6589C34.9125 21.6589 35.4222 21.1328 35.4222 20.475V19.0281C35.4222 12.5661 33.449 10.6094 27.0035 10.6094H16.6445V14.605C17.2858 14.605 17.812 15.1311 17.812 15.7724V20.1791C17.812 20.8203 17.2858 21.3465 16.6445 21.3465V25.4736C17.2858 25.4736 17.812 25.9998 17.812 26.6411V31.0477C17.812 31.689 17.2858 32.2152 16.6445 32.2152V36.1779H27.0035C33.449 36.1779 35.4222 34.2048 35.4222 27.7592C35.4222 27.1179 34.9125 26.5918 34.2712 26.5918C32.89 26.5918 31.7883 25.4901 31.7883 24.1253C31.7883 22.7606 32.89 21.6589 34.2712 21.6589Z" fill="#737577"/>
			...
			<div class="mt-3 flex items-center gap-1 text-xs text-[#DD488B]">
				...
				<svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
					<rect x="2.9625" y="0.37461" width="4.49532" height="0.74922" fill="#D9D9D9" stroke="#B3B5B7" stroke-width="0.74922"/>
					<rect x="7.45664" y="5.62539" width="5.24454" height="0.74922" transform="rotate(-90 7.45664 5.62539)" fill="#D9D9D9" stroke="#B3B5B7" stroke-width="0.74922"/>
					<rect x="0.529778" y="7.57812" width="8.89866" height="0.74922" transform="rotate(-45 0.529778 7.57812)" fill="#D9D9D9" stroke="#B3B5B7" stroke-width="0.74922"/>
				</svg>
			</div>

			<div class="my-4 flex items-center justify-between">
				<label class="text-sm font-medium text-gray-700">Allow Group Registration</label>
				<button
					aria-label="toggle"
