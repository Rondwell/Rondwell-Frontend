...
<script>
	...
	const menuItems = [
		...
		{
			// GAP 4 — kept in step with Sidebar.svelte. Two nav components,
			// one menu; letting them diverge is how "Send Gift" ends up
			// missing for exactly the newly-onboarded users it converts best.
			id: 'gift',
			label: 'Send Gift',
			icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
