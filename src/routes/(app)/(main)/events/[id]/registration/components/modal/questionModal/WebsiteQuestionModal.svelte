<!-- src/lib/components/WebsiteQuestionModal.svelte -->
<script lang="ts">
		...
		>
			...
			<div class="space-y-6">
				<div class="flex items-center space-x-3">
					...
					>
						<img src="/link-2.svg" alt="arrow back" />
					</div>
					<div>
						<h3 class="font-medium">Website</h3>
						<p class="text-sm text-gray-600">Ask for a website URL</p>
					</div>
				</div>
				...
				<div>
					...
					<input
						...
						placeholder="Website"
						class="w-full rounded-md border border-gray-300 px-3 py-2 focus:ring-0"
					/>
					<div class="mt-2 text-xs font-medium text-gray-400">{questionData.helpText}</div>
				</div>
