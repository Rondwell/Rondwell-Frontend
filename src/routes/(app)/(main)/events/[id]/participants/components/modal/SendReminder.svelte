...
{#if open}
	<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
				...
				<div>
					...
					<div class="mt-6">
						<label class="flex text-gray-900" for="first_name">
							Select Reminder Type <span class="text-blue-600">*</span></label
						>
      ...
      {selectedOption === option.id ? 'bg-[#F0F0F0]' : ''}"
					...
					<div class="mt-6">
						<label class="flex text-gray-900" for="first_name">
							custom Message <span class="text-blue-600">*</span>
							<span class="ml-1 text-gray-700">(Optional)</span></label
						>
						<textarea
							placeholder="Pre-filled with a default message based on reminder type, editable. Rich Text Editor"
							rows="4"
