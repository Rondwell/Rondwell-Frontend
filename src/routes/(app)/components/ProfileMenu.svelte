    ...
    >
        ...
        <div class="mt-4 space-y-3">
             <a href="/vendor/profile" on:click={onClose} class="flex cursor-pointer items-center gap-2">
                <div class="flex h-[36px] w-[36px] cursor-pointer items-center rounded-full bg-[#E2E4E5] p-2">
                     <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9.12187 8.1525C9.04687 8.145 8.95687 8.145 8.87437 8.1525C7.08937 8.0925 5.67188 6.63 5.67188 4.83C5.67187 2.9925 7.15688 1.5 9.00188 1.5C10.8394 1.5 12.3319 2.9925 12.3319 4.83C12.3244 6.63 10.9069 8.0925 9.12187 8.1525Z" stroke="#2A2D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M5.36906 10.92C3.55406 12.135 3.55406 14.115 5.36906 15.3225C7.43156 16.7025 10.8141 16.7025 12.8766 15.3225C14.6916 14.1075 14.6916 12.1275 12.8766 10.92C10.8216 9.5475 7.43906 9.5475 5.36906 10.92Z" stroke="#2A2D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
            ...
            <div class="flex cursor-pointer items-center gap-2">
                 <div class="flex h-[36px] w-[36px] cursor-pointer items-center rounded-full bg-[#E2E4E5] p-2">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13.5 14.1453H12.93C12.33 14.1453 11.76 14.3778 11.34 14.7978L10.0575 16.0653C9.4725 16.6428 8.52 16.6428 7.935 16.0653L6.6525 14.7978C6.2325 14.3778 5.655 14.1453 5.0625 14.1453H4.5C3.255 14.1453 2.25 13.1478 2.25 11.9178V3.73529C2.25 2.50529 3.255 1.50781 4.5 1.50781H13.5C14.745 1.50781 15.75 2.50529 15.75 3.73529V11.9178C15.75 13.1403 14.745 14.1453 13.5 14.1453Z" stroke="#2A2D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M5.25 6.86911C5.25 6.17161 5.82 5.60156 6.5175 5.60156C7.215 5.60156 7.75 6.17161 7.785 6.86911C7.785 8.27911 5.7825 8.42911 5.34 9.77161C5.25 10.0491 5.4825 10.3266 5.775 10.3266H7.785" stroke="#2A2D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M12.0303 10.3206V6.03816C12.0303 5.84316 11.9028 5.67062 11.7153 5.61812C11.5278 5.56562 11.3253 5.64062 11.2203 5.80562C10.6803 6.67562 10.0953 7.66563 9.58531 8.53563C9.50281 8.67813 9.50281 8.86563 9.58531 9.00813C9.66781 9.15063 9.82531 9.24059 9.99781 9.24059H12.7503" stroke="#2A2D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
                <span>Support</span>
            </div>
