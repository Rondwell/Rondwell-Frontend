<script lang="ts">
	import { getSpeakerCollaborations } from '$lib/services/speaker.services';
	...
	async function fetchRequests() {
		loading = true;
		try {
			const filters: any = { page: currentPage, limit, sortBy: 'createdAt', sortOrder: 'desc', type: 'SENT_REQUEST' };
...
<SentRequestDetailModal bind:open={showDetailModal} collaborationId={selectedId} initialData={selectedReq} mode={modalMode} {speakerName} {speakerProfilePictureUrl} onStatusChanged={() => fetchRequests()} />
