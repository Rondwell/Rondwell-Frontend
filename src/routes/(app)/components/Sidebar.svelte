...
<script>
	...
	const menuItems = [
		...
		{
			// GAP 4 — the viral acquisition loop. Top-level on purpose: someone
			// who received a gift link comes back to make their own, and burying
			// that four levels inside an event is how the loop dies.
			id: 'gift',
			label: 'Gift',
			icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
